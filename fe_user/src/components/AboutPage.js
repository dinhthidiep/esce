  ...
  const coreValues = [
    {
      ...
      icon: 'Leaf',
      title: 'Bền vững',
      description: 'Cam kết phát triển du lịch sinh thái bền vững, bảo vệ môi trường và gìn giữ văn hóa địa phương.'
    },
    {
      id: 2,
      icon: 'Shield',
      title: 'An toàn',
      description: 'Đảm bảo an toàn tuyệt đối cho khách hàng với các dịch vụ được kiểm định chất lượng nghiêm ngặt.'
    },
    {
      id: 3,
      icon: 'Users',
      title: 'Cộng đồng',
      description: 'Xây dựng cộng đồng du lịch có trách nhiệm, kết nối mọi người với thiên nhiên và văn hóa địa phương.'
    },
    {
      id: 4,
      icon: 'Gift',
          ...
          <div className="about-hero-container">
            <div className={`about-hero-content ${isVisible ? 'fade-in-up' : ''}`}>
              ...
              <p className="about-hero-description">
                Chúng tôi là đơn vị tiên phong trong lĩnh vực du lịch sinh thái tại Đà Nẵng, 
                chuyên cung cấp các dịch vụ du lịch bền vững, thân thiện với môi trường và 
            ...
            <div className="about-company-grid">
              <div className={`about-company-content ${isVisible ? 'fade-in-left' : ''}`}>
                ...
                <div className="about-company-text">
                  <p>
                    ESCE Du Lịch Sinh Thái được thành lập với sứ mệnh mang đến những trải nghiệm 
                    du lịch độc đáo, bền vững tại Đà Nẵng - một trong những điểm đến du lịch 
                    hàng đầu Việt Nam.
                  </p>
                  <p>
                    Với đội ngũ chuyên nghiệp, giàu kinh nghiệm và đam mê du lịch, chúng tôi 
                    không chỉ cung cấp dịch vụ đặt tour theo nhóm thông minh mà còn cam kết 
                    góp phần bảo vệ môi trường và phát triển du lịch bền vững.
                  </p>
                  <p>
                    Chúng tôi tin rằng du lịch không chỉ là khám phá mà còn là cơ hội để kết nối 
                    với thiên nhiên, hiểu biết về văn hóa địa phương và tạo ra những kỷ niệm 
                    đáng nhớ cùng bạn bè, gia đình.
                  </p>
                </div>
              </div>
              ...
              <Card className={`mission-card ${isVisible ? 'fade-in-up' : ''}`}>
                <CardContent className="mission-content">
                  ...
                  <p className="mission-text">
                    Mang đến những trải nghiệm du lịch sinh thái bền vững, chất lượng cao 
                    tại Đà Nẵng, góp phần bảo vệ môi trường và phát triển du lịch có trách nhiệm. 
                    Chúng tôi cam kết tạo ra giá trị cho khách hàng, cộng đồng địa phương và 
                    thiên nhiên.
                  </p>
                </CardContent>
              </Card>

              <Card className={`vision-card ${isVisible ? 'fade-in-up' : ''}`} style={{ animationDelay: '0.2s' }}>
                <CardContent className="vision-content">
                  ...
                  <p className="vision-text">
                    Trở thành đơn vị dẫn đầu trong lĩnh vực du lịch sinh thái tại miền Trung Việt Nam, 
                    được công nhận về chất lượng dịch vụ, tính bền vững và đóng góp tích cực cho 
                    cộng đồng. Chúng tôi hướng tới việc xây dựng một hệ sinh thái du lịch xanh, 
        ...
        <section className="about-stats-section" id="stats" aria-labelledby="stats-title">
          <div className="section-container">
            <div className="section-header">
              ...
              <p className="section-subtitle">
                Những con số thể hiện sự tin tưởng và hài lòng của khách hàng
              </p>
            </div>
          ...
          <div className="section-container">
            <div className={`about-cta-content ${isVisible ? 'fade-in-up' : ''}`}>
              ...
              <p className="about-cta-subtitle">
                ...
                tuyệt vời và ý nghĩa nhất tại Đà Nẵng.
              </p>
