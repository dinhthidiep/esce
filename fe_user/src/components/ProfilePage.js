        ...
        <div className="profile-container">
          ...
          <aside className="profile-sidebar">
            <div className="sidebar-user-info">
              ...
              <Badge variant="outline" className="sidebar-role-badge">
                {roleName}
              </Badge>
            </div>
                ...
                <div className="profile-fields-column">
                  <div className="form-field-compact">
                    ...
                    <input
                      ...
                      id="name"
                      name="name"
                      className={`form-input-compact ${fieldErrors.name ? 'input-error' : ''}`}
                      value={formData.name}
                  ...
                  <div className="form-field-compact">
                    ...
                    <input
                      ...
                      id="phone"
                      name="phone"
                      className={`form-input-compact ${fieldErrors.phone ? 'input-error' : ''}`}
                ...
                <div className="profile-fields-column">
                  ...
                  <div className="form-field-compact">
                    ...
                    <input
                      ...
                      id="dob"
                      name="dob"
                      className={`form-input-compact ${fieldErrors.dob ? 'input-error' : ''}`}
                      value={formData.dob}
                      onChange={handleInputChange}
